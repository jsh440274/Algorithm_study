...
public class no6 {
    public String[] solution(String[] dictionary, String[] command) {
        String[] answer = new String[1];
        node start = new node("", null);

        for (int i = 0; i < dictionary.length; i++) {
            String[] dict = dictionary[i].split("/");
            node p = start;
...
//                    p =
    ...
    public class node {
        ...
        public node(String name, Set<node> next) {
            this.name = name;
            this.next = next;
        }
    }

//    public String[] dfs(node head) {
//
//    }
}
/*문제 설명
