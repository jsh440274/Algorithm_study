public class main {
    public static void main(String[] args) {
        ...
        int[] res1_1 = no1.solution(n, s1);
        int[] res1_2 = no1.solution(n, s2);
        int[] res1_3 = no1.solution(n, s3);
        ...
        int res2_1 = no2.solution(word1, pages1);
        int res2_2 = no2.solution(word2, pages2);
